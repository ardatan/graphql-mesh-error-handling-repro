...
export type Query = {
  greeting?: Maybe<Scalars['JSON']['output']>;
  throwMe?: Maybe<Scalars['String']['output']>;
};
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  greeting?: Resolver<Maybe<ResolversTypes['JSON']>, ParentType, ContextType>;
  throwMe?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
}>;
