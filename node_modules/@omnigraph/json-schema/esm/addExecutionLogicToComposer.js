import { getNamedType, GraphQLInt, GraphQLObjectType, GraphQLString, isInterfaceType, } from 'graphql';
import { GraphQLJSON, } from 'graphql-compose';
import { process } from '@graphql-mesh/cross-helpers';
import { MapperKind, mapSchema } from '@graphql-tools/utils';
import { HTTPOperationDirective, LinkDirective, LinkResolverDirective, PubSubOperationDirective, ResolveRootDirective, ResponseMetadataDirective, TransportDirective, } from './directives.js';
...
export function addExecutionDirectivesToComposer(subgraphName, { schemaComposer, logger, operations, operationHeaders, endpoint, queryParams, queryStringOptions, handlerName, }) {
